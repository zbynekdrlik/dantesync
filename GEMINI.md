...
- **Autonomous Deployment:** ALWAYS install and verify updates on remote machines (Windows/Linux) using available tools (SSH, etc.). NEVER ask the user to perform the update or verification manually if you have access.
